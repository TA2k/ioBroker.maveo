...
systemDictionary = {
    "maveo adapter settings": {
        en: "Adapter settings for maveo",
        de: "Adaptereinstellungen für maveo",
        ru: "Настройки адаптера для maveo",
        pt: "Configurações do adaptador para maveo",
        nl: "Adapterinstellingen voor maveo",
        fr: "Paramètres d'adaptateur pour maveo",
        it: "Impostazioni dell'adattatore per maveo",
        es: "Ajustes del adaptador para maveo",
        pl: "Ustawienia adaptera dla maveo",
        "zh-cn": "maveo的适配器设置",
    },
    "App Email": {
        en: "App Email",
